...
YUI.add('yui', function(Y){}, '3.5.1-2' ,{use:['yui-base','get','features','intl-base','yui-log','yui-later']});
...
}, '3.5.1-2' ,{requires:['dom-base', 'dom-style']});
...
}, '3.5.1-2' ,{requires:['selector-native']});
...
}, '3.5.1-2' ,{requires:['event-custom-base']});
...
}, '3.5.1-2' ,{requires:['dom-core', 'selector']});
...
}, '3.5.1-2' ,{requires:['dom-base', 'node-core', 'event-base']});
(function () {
...
}, '3.5.1-2' ,{requires:['pluginhost-base']});
...
}, '3.5.1-2' ,{requires:['node-base', 'event-delegate']});
...
}, '3.5.1-2' ,{requires:['node-base', 'pluginhost']});
...
}, '3.5.1-2' ,{requires:['node-base', 'dom-screen']});
...
}, '3.5.1-2' ,{requires:['dom-style', 'node-base']});
...
}, '3.5.1-2' ,{requires:['event-custom-base', 'querystring-stringify-simple']});
...
}, '3.5.1-2' ,{requires:['selector-native', 'selector-css2']});
YUI.add('yui-log', function(Y) {
...
}, '3.5.1-2' ,{use:['yui','oop','dom','event-custom-base','event-base','pluginhost','node','event-delegate','io-base','json-parse','transition','selector-css3','dom-style-ie','querystring-stringify-simple']});
var Y = YUI().use('*');
