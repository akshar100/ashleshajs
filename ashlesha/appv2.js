...
YUI({
    ...
    app.route("/brandpages", function(req, res) {
        Y.log("Brand Pages");
        this.showView('home', {
            req: req,
            res: res,
    ...
    app.route("/brandpage/new", function(req, res) {
        this.showView('home', {
            req: req,
            res: res,
            user: currentUser,
    ...
    app.route("/fanpage/:id", function(req, res) {
     ...
     app.route("/search", function(req, res) {
     ...
     app.route("/search/:keyword", function(req, res) {
    ...
    //Just checking if the current user is logged in
    currentUser.load();
